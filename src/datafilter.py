...
def datasplit(filename):
    ...
    wf1 = open("data/11.json", "w")
    wf2 = open("data/12.json", "w")
    wf3 = open("data/17.json", "w")
    wf4 = open("data/25.json", "w")
    wf5 = open("data/26.json", "w")
    wf6 = open("data/28.json", "w")
    ...
    for str in f:
        for ipstr in ip_list:
            if ipstr in str and target_ip in str:
...
def dataextract(filename):
    ...
    wf1 = open("data/exclude.json", "a")
    wf2 = open("data/include.json", "a")
...
if __name__ == '__main__':
    ...
    # dataextract("dataset.json")
    # dataextract("dataset_0415.json")
    datasplit("data/include.json")
